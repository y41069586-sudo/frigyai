...
enum Translations {
    static let table: [String: [AppLanguage: String]] = [
        ...
        "Nicht unterstützt": [.en: "Not supported", .fr: "Non pris en charge", .es: "No compatible", .it: "Non supportato", .hi: "समर्थित नहीं"],
        ...
        "In Apple Health verwalten": [.en: "Manage in Apple Health", .fr: "Gérer dans Apple Santé", .es: "Gestionar en Apple Salud", .it: "Gestisci in Apple Salute", .hi: "Apple Health में प्रबंधित करें"],
        "Apple Health ist auf diesem Gerät nicht verfügbar": [.en: "Apple Health isn't available on this device", .fr: "Apple Santé n'est pas disponible sur cet appareil", .es: "Apple Salud no está disponible en este dispositivo", .it: "Apple Salute non è disponibile su questo dispositivo", .hi: "इस डिवाइस पर Apple Health उपलब्ध नहीं है"],
        "Apple Health gibt es nur auf dem iPhone. Öffne Frigy auf deinem iPhone, um Schritte und Aktivität zu verbinden.": [.en: "Apple Health is iPhone-only. Open Frigy on your iPhone to connect steps and activity.", .fr: "Apple Santé n'existe que sur iPhone. Ouvre Frigy sur ton iPhone pour connecter les pas et l'activité.", .es: "Apple Salud solo existe en el iPhone. Abre Frigy en tu iPhone para conectar pasos y actividad.", .it: "Apple Salute è disponibile solo su iPhone. Apri Frigy sul tuo iPhone per collegare passi e attività.", .hi: "Apple Health केवल iPhone पर है। कदम और गतिविधि कनेक्ट करने के लिए अपने iPhone पर Frigy खोलें।"],
        "Frigy kann deine Schritte und aktiven Kalorien aus Apple Health lesen, um deine Aktivität im Dashboard anzuzeigen. Zum vollständigen Widerruf des Zugriffs verwalte Frigy in der Apple-Health-App.": [.en: "Frigy can read your steps and active calories from Apple Health to show your activity on the dashboard. To fully revoke access, manage Frigy in the Apple Health app.", .fr: "Frigy peut lire vos pas et calories actives depuis Apple Santé pour afficher votre activité. Pour révoquer complètement l'accès, gérez Frigy dans l'app Apple Santé.", .es: "Frigy puede leer tus pasos y calorías activas de Apple Salud para mostrar tu actividad. Para revocar el acceso por completo, gestiona Frigy en la app Apple Salud.", .it: "Frigy può leggere i tuoi passi e le calorie attive da Apple Salute per mostrare la tua attività. Per revocare completamente l'accesso, gestisci Frigy nell'app Apple Salute.", .hi: "Frigy आपकी गतिविधि दिखाने के लिए Apple Health से कदम और सक्रिय कैलोरी पढ़ सकता है। पहुँच पूरी तरह रद्द करने के लिए Apple Health ऐप में Frigy प्रबंधित करें।"],
        ...
        "Frigy AI\nfreigeschaltet! 🎉": [.en: "Frigy AI\nunlocked! 🎉", .fr: "Frigy AI\ndébloqué ! 🎉", .es: "¡Frigy AI\ndesbloqueado! 🎉", .it: "Frigy AI\nsbloccato! 🎉", .hi: "Frigy AI\nअनलॉक हो गया! 🎉"],
        "Dein Jahresabo ist aktiv. Du hast jetzt vollen Zugriff auf alle Funktionen.": [.en: "Your yearly subscription is active. You now have full access to all features.", .fr: "Ton abonnement annuel est actif. Tu as maintenant un accès complet à toutes les fonctionnalités.", .es: "Tu suscripción anual está activa. Ahora tienes acceso completo a todas las funciones.", .it: "Il tuo abbonamento annuale è attivo. Ora hai accesso completo a tutte le funzionalità.", .hi: "आपकी वार्षिक सदस्यता सक्रिय है। अब आपके पास सभी सुविधाओं तक पूर्ण पहुंच है।"],
        "Deine Testphase läuft. Du hast jetzt vollen Zugriff auf alle Funktionen.": [.en: "Your trial is running. You now have full access to all features.", .fr: "Ton essai est en cours. Tu as maintenant un accès complet à toutes les fonctionnalités.", .es: "Tu prueba está en curso. Ahora tienes acceso completo a todas las funciones.", .it: "La tua prova è in corso. Ora hai accesso completo a tutte le funzionalità.", .hi: "आपका परीक्षण चल रहा है। अब आपके पास सभी सुविधाओं तक पूर्ण पहुंच है।"],
