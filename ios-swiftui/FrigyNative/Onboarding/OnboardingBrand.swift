...
// MARK: - Number scroll picker (wheel + rolling-digit display)

/// A wheel picker with a large animated number display above it.
/// The displayed value rolls up/down with iOS's numericText transition as the
/// wheel spins — giving the classic slot-machine digit animation.
struct NumberScrollInput: View {
