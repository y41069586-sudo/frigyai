...
export const CookingTimeStep = ({ userData, setUserData }: StepProps) => {
  ...
  const timeOptions = [
    {
      id: "quick" as const,
      label: t.cookingTime15Label,
      icon: Zap,
      desc: t.cookingTime15Desc,
    ...
    {
      id: "medium" as const,
      label: t.cookingTime30Label,
      icon: Utensils,
      desc: t.cookingTime30Desc,
    ...
    {
      id: "long" as const,
      label: t.cookingTime45Label,
      icon: ChefHat,
      desc: t.cookingTime45Desc,
            ...
            return (
              ...
              >
                ...
                <div className="relative z-10 flex items-center gap-4">
                  <div
                    className={`w-10 h-10 rounded-xl ${option.bgColor} flex items-center justify-center ${option.iconColor}`}
                  >
