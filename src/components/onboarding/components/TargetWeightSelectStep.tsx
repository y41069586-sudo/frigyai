  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="px-6 pt-4 pb-3 shrink-0 [@media(min-height:740px)]:pt-6 [@media(min-height:740px)]:pb-4"
      >
        <h1
      ...
      <div className="relative z-30 flex justify-center px-5 pb-3 shrink-0 [@media(min-height:740px)]:pb-4">
