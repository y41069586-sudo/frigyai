...
export const PremiumLockOverlay = ({ 
  ...
  return (
    <motion.div
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
      className={`absolute inset-0 z-10 flex flex-col items-center justify-start pt-16 sm:justify-center sm:pt-0 backdrop-blur-[2px] bg-background/40 rounded-xl ${className}`}
    >
      <motion.div
