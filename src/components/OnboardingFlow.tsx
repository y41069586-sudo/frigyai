                ...
                <div className="space-y-4 w-full max-w-sm">
                  ...
                  <div className="space-y-3 mt-6">
                    <motion.button
                      ...
                      onClick={() => {
                        // Just save preference, NOT connected status
                        localStorage.setItem('healthSyncPreference', 'appleHealth');
                        toast({ 
                          title: "Apple Health ausgewählt 🍎",
                          description: "Verbinde dich nach der App-Installation."
                        });
                        handleNext();
                      }}
                    ...
                    >
                      ...
                      <div className="text-left">
                        <span className="font-medium block">{t.connectAppleHealth}</span>
                        <span className="text-xs text-muted-foreground">Nur in iOS App verfügbar</span>
                      </div>
                    </motion.button>
                    <motion.button
                      initial={{ opacity: 0, x: -20 }}
                      ...
                      onClick={() => {
                        // Just save preference, NOT connected status
                        localStorage.setItem('healthSyncPreference', 'googleFit');
                        toast({ 
                          title: "Google Fit ausgewählt 🏃",
                          description: "Verbinde dich nach der App-Installation."
                        });
                        handleNext();
                      }}
                    ...
                    >
                      ...
                      <div className="text-left">
                        <span className="font-medium block">{t.connectGoogleFit}</span>
                        <span className="text-xs text-muted-foreground">Nur in Android App verfügbar</span>
                      </div>
                    </motion.button>
                    <motion.button
                      initial={{ opacity: 0 }}
