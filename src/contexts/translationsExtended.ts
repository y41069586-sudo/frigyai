...
export const extendedTranslations: Record<Language, ExtendedTranslations> = {
  de: {
    ...
    premiumTrialHint: "Preise werden direkt aus dem App Store / Google Play geladen",
  ...
  en: {
    ...
    premiumTrialHint: "Prices are loaded directly from the App Store / Google Play",
  ...
  fr: {
    ...
    premiumTrialHint: "Les prix sont chargés depuis l'App Store / Google Play",
