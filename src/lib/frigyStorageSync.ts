...
export const FRIGY_TRACKER_SETTINGS_UPDATED = "frigy-tracker-settings-updated";
...
export function notifyTrackerSettingsUpdated(): void {
  if (typeof window === "undefined") return;
  window.dispatchEvent(new CustomEvent(FRIGY_TRACKER_SETTINGS_UPDATED));
